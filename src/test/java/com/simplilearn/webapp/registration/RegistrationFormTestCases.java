...
public class RegistrationFormTestCases {
    ...
    final  String siteURL = "file:///C:/Users/Rajasekar/Desktop/simplilearn/Phase_5_FSD/FSD-5%20WorkSpace-Practice-Projects/AutomateWebApp/static/registrationForm.html";
	...
	void testEmail() throws InterruptedException {
		...
		//Enter yourEmail
		input.sendKeys("Rajasekarsofia@gmail.com");
		Thread.sleep(2000);
	...
	void testPassword() throws InterruptedException, IOException {
	 ...
	 //Step-1 :: type cast driver object into takeScreenshot instance 
      ...
      //Step-2 :: Generate a screenshot as file 
		...
		FileHandler.copy(rsc,new File("C:\\Users\\Rajasekar\\Desktop\\simplilearn\\Phase_5_FSD\\FSD-5 WorkSpace-Practice-Projects\\AutomateWebApp\\screenshot\\reg-pasword.png"));
	...
	void testRepeatPassword() throws InterruptedException, IOException {
	 ...
	 //Step-1 :: type cast driver object into takeScreenshot instance 
      ...
      //Step-2 :: Generate a screenshot as file 
		File rsc = tsc.getScreenshotAs(OutputType.FILE);
		FileHandler.copy(rsc,new File("C:\\Users\\Rajasekar\\Desktop\\simplilearn\\Phase_5_FSD\\FSD-5 WorkSpace-Practice-Projects\\AutomateWebApp\\screenshot\\reg-repet-password.png"));
    ...
    void testToVerifyRadioButtonExist() throws InterruptedException, IOException {
	 ...
	 //Step-1 :: type cast driver object into takeScreenshot instance 
      ...
      //Step-2 :: Generate a screenshot as file 
		File rsc = tsc.getScreenshotAs(OutputType.FILE);
		FileHandler.copy(rsc,new File("C:\\Users\\Rajasekar\\Desktop\\simplilearn\\Phase_5_FSD\\FSD-5 WorkSpace-Practice-Projects\\AutomateWebApp\\screenshot\\reg-radio-buttons.png"));
	...
	//Snapshot:: size
	 ...
	 //Step-1 :: type cast driver object into takeScreenshot instance 
      ...
      //Step-2 :: Generate a screenshot as file 
		File rsc = tsc.getScreenshotAs(OutputType.FILE);
		FileHandler.copy(rsc,new File("C:\\Users\\Rajasekar\\Desktop\\simplilearn\\Phase_5_FSD\\FSD-5 WorkSpace-Practice-Projects\\AutomateWebApp\\screenshot\\radio-button-1.png"));
    ...
    void testToVerifyRadioButtonTwoSelected() throws InterruptedException, IOException {
	 ...
	 //Step-1 :: type cast driver object into takeScreenshot instance 
      ...
      //Step-2 :: Generate a screenshot as file 
		File rsc = tsc.getScreenshotAs(OutputType.FILE);
		FileHandler.copy(rsc,new File("C:\\Users\\Rajasekar\\Desktop\\simplilearn\\Phase_5_FSD\\FSD-5 WorkSpace-Practice-Projects\\AutomateWebApp\\screenshot\\radio-button-2.png"));
    ...
    void testToVerifyRadioButtonSelected() throws InterruptedException, IOException {
		...
		//Snapshot:: size
			 ...
			 //Step-1 :: type cast driver object into takeScreenshot instance 
		      ...
		      //Step-2 :: Generate a screenshot as file 
				File rsc = tsc.getScreenshotAs(OutputType.FILE);
				FileHandler.copy(rsc,new File("C:\\Users\\Rajasekar\\Desktop\\simplilearn\\Phase_5_FSD\\FSD-5 WorkSpace-Practice-Projects\\AutomateWebApp\\screenshot\\radio-button-3.png"));
	...
	void testToVerifyCheckboxExist() throws IOException {
		...
		//Snapshot:: size
			 ...
			 //Step-1 :: type cast driver object into takeScreenshot instance 
		      ...
		      //Step-2 :: Generate a screenshot as file 
				File rsc = tsc.getScreenshotAs(OutputType.FILE);
				FileHandler.copy(rsc,new File("C:\\Users\\Rajasekar\\Desktop\\simplilearn\\Phase_5_FSD\\FSD-5 WorkSpace-Practice-Projects\\AutomateWebApp\\screenshot\\reg-check-box.png"));
	...
	void testToVerifyCheckBoxOneSelected() throws InterruptedException, IOException {
		...
		//Snapshot:: size
			 ...
			 //Step-1 :: type cast driver object into takeScreenshot instance 
		      ...
		      //Step-2 :: Generate a screenshot as file 
				File rsc = tsc.getScreenshotAs(OutputType.FILE);
				FileHandler.copy(rsc,new File("C:\\Users\\Rajasekar\\Desktop\\simplilearn\\Phase_5_FSD\\FSD-5 WorkSpace-Practice-Projects\\AutomateWebApp\\screenshot\\reg-check-box-1.png"));
	...
	void testToVerifyCheckBoxTwoSelected() throws InterruptedException, IOException {
		...
		//Snapshot:: size
			 ...
			 //Step-1 :: type cast driver object into takeScreenshot instance 
		      ...
		      //Step-2 :: Generate a screenshot as file 
				File rsc = tsc.getScreenshotAs(OutputType.FILE);
				FileHandler.copy(rsc,new File("C:\\Users\\Rajasekar\\Desktop\\simplilearn\\Phase_5_FSD\\FSD-5 WorkSpace-Practice-Projects\\AutomateWebApp\\screenshot\\reg-check-box-2.png"));
	...
	void testToVerifyCheckBoxThreeSelected() throws InterruptedException, IOException {
	 ...
	 //Step-1 :: type cast driver object into takeScreenshot instance 
      ...
      //Step-2 :: Generate a screenshot as file 
		File rsc = tsc.getScreenshotAs(OutputType.FILE);
		FileHandler.copy(rsc,new File("C:\\Users\\Rajasekar\\Desktop\\simplilearn\\Phase_5_FSD\\FSD-5 WorkSpace-Practice-Projects\\AutomateWebApp\\screenshot\\reg-check-box-3.png"));
	...
	void testToVerifyRegistrationButton() throws InterruptedException, IOException {
	 ...
	 //Step-1 :: type cast driver object into takeScreenshot instance 
      ...
      //Step-2 :: Generate a screenshot as file 
		File rsc = tsc.getScreenshotAs(OutputType.FILE);
		FileHandler.copy(rsc,new File("C:\\Users\\Rajasekar\\Desktop\\simplilearn\\Phase_5_FSD\\FSD-5 WorkSpace-Practice-Projects\\AutomateWebApp\\screenshot\\reg-button.png"));
