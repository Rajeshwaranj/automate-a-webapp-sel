...
public class LogInFormTestcases {
     ...
     final  String siteURL = "file:///C:/Users/Rajasekar/Desktop/simplilearn/Phase_5_FSD/FSD-5%20WorkSpace-Practice-Projects/AutomateWebApp/static/loginForm.html";
	...
	void testUserInput() throws InterruptedException, IOException {
		//Find Input Field
			 ...
			 private void takeScreenShot(String filename) throws IOException {
					 ...
					 FileHandler.copy(rsc, new File("C:\\Users\\Rajasekar\\Desktop\\simplilearn\\Phase_5_FSD\\FSD-5 WorkSpace-Practice-Projects\\AutomateWebApp\\screenshot" + filename));
			}
		...
		//Find Input Field
			 ...
			 //Step-1 :: type cast driver object into takeScreenshot instance 
		      ...
		      //Step-2 :: Generate a screenshot as file 
				File rsc = tsc.getScreenshotAs(OutputType.FILE);
				FileHandler.copy(rsc,new File("C:\\Users\\Rajasekar\\Desktop\\simplilearn\\Phase_5_FSD\\FSD-5 WorkSpace-Practice-Projects\\AutomateWebApp\\screenshot\\pasword.png"));
	...
	void testLogInButton() throws InterruptedException, IOException {
		//Find Input Field
		      ...
		      //Step-2 :: Generate a screenshot as file 
				File rsc = tsc.getScreenshotAs(OutputType.FILE);
				FileHandler.copy(rsc,new File("C:\\Users\\Rajasekar\\Desktop\\simplilearn\\Phase_5_FSD\\FSD-5 WorkSpace-Practice-Projects\\AutomateWebApp\\screenshot\\pasword-repet.png"));
	...
	void testCheckBox() throws InterruptedException, IOException {
		//Find Input Field
		      ...
		      //Step-2 :: Generate a screenshot as file 
				File rsc = tsc.getScreenshotAs(OutputType.FILE);
				FileHandler.copy(rsc,new File("C:\\Users\\Rajasekar\\Desktop\\simplilearn\\Phase_5_FSD\\FSD-5 WorkSpace-Practice-Projects\\AutomateWebApp\\screenshot\\checkBox.png"));
	...
	void testCancelButton() throws InterruptedException, IOException {
		//Find Input Field
		      ...
		      //Step-2 :: Generate a screenshot as file 
				File rsc = tsc.getScreenshotAs(OutputType.FILE);
				FileHandler.copy(rsc,new File("C:\\Users\\Rajasekar\\Desktop\\simplilearn\\Phase_5_FSD\\FSD-5 WorkSpace-Practice-Projects\\AutomateWebApp\\screenshot\\cancel.png"));
	...
	void testLink() throws InterruptedException, IOException {
		//Find Input Field
		      ...
		      //Step-2 :: Generate a screenshot as file 
				File rsc = tsc.getScreenshotAs(OutputType.FILE);
				FileHandler.copy(rsc,new File("C:\\Users\\Rajasekar\\Desktop\\simplilearn\\Phase_5_FSD\\FSD-5 WorkSpace-Practice-Projects\\AutomateWebApp\\screenshot\\link-verification.png"));
